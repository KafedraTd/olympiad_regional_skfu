...
var fieldGrades = [
  ...
  ['data[grafa2-8]', 1],
  // задача 2
  ['data[grafa2-9]', 3], ['data[grafa2-10]', 2], ['data[grafa2-11]', 1],
  // задача 3
  ['data[grafa2-12]', 3], ['data[check2kt]', 2], ['data[grafa3-1]', 1],
  // задача 4
  ['data[grafa20-2]', 1], ['data[grafa9-7]', 0.35], ['data[grafa9-8]', 0.35], ['data[grafa9-9]', 0.35], ['data[grafa9-10]', 0.35], ['data[grafa9-11]', 0.35],
  ['data[grafa9-12]', 0.35], ['data[grafa11]', 0.35], ['data[grafa12]', 0.35], ['data[grafa14-1]', 0.35], ['data[grafa14-2]', 0.35], ['data[grafa14-3]', 0.35],
  ['data[grafa14-4]', 0.35], ['data[grafa14-5]', 0.35], ['data[grafa14-6]', 0.35], ['data[grafa14-7]', 0.35], ['data[grafa14-8]', 0.35], ['data[grafa14-9]', 0.35],
  ['data[grafa14-10]', 0.35], ['data[grafa14-11]', 0.35], ['data[grafa14-12]', 0.35], ['data[grafa15-1]', 0], ['data[grafa15-2]', 0],
